...
cv2.imwrite('outputs\patinet_{0}_{1}CH_contours_orig.jpg'.format(patient_idx, channel_number), I)
...
# Save the canvas with the contours in red
cv2.imwrite('outputs\patinet_{0}_{1}CH_contours_processed.jpg'.format(patient_idx, channel_number), I_out)
